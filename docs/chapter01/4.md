...
단순하게 2진수 변환을 해보았습니다. 그렇다면 이것으로 무엇을 할 수 있을까요?
조금 더 변환해보겠습니다.
...
각 항이 제곱관계라는 것입니다. 그러면 13이라는 수를 이진수로 변환한 후에 이를 활용하면 거듭제곱을 좀 더 빠르게 할 수 있지 않을까요?
한 번 코드로 작성해보겠습니다.
...
당연히 mod를 한 번만 하는 위의 방법이 빨라보이지만, 실험해보면 평균적으로 아래 방법이 빠른 것을 알 수 있습니다.
그 이유는 큰 수 연산이 시간이 오래걸리기 때문입니다. 
